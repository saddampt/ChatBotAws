...
namespace dotnetLexChatBot.Data
{
    public class AWSLexService : IAWSLexService
    {
        ...
        private readonly string LexUserID = "LexDotNetBot123";
        private readonly bool shouldInit = true;
        ...
        public async Task<PostTextResponse> SendTextMsgToLex(string messageToSend, Dictionary<string, string> lexSessionAttributes)
        {
            _lexSessionAttribs = lexSessionAttributes;
            return await SendTextMsgToLex(messageToSend);

        }
        public async Task<PostTextResponse> SendTextMsgToLex(string messageToSend)
        {   
